            ...
            case this.swTypeVal == Constants.DeviceTypeBlindsPercentageInverted:
                {
                    ...
                    if (this.batteryRef && this.batteryRef !== 255) { // if batteryRef == 255 we're running on mains
                        ...
                        this.gracefullyAddCharacteristic(blindService, Characteristic.BatteryLevel).on('get', this.getBatteryLevel.bind(this));
                    }
            ...
            case this.Type == "Humidity":
                {
                    ...
                    if (this.batteryRef && this.batteryRef !== 255) {
                        this.gracefullyAddCharacteristic(service, Characteristic.StatusLowBattery).on('get', this.getLowBatteryStatus.bind(this));
                        this.gracefullyAddCharacteristic(service, Characteristic.BatteryLevel).on('get', this.getBatteryLevel.bind(this));
                    }
                    this.services.push(service);
                    break;
                }
